...
"[project]/lib/admin-helpers.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function isAdmin() {
    try {
        ...
        let user = null;
        if (__TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"].isValid(session.user.id)) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/admin-helpers.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/mongodb [external] (mongodb, cjs)");
;
;
...
async function GET(request) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAdmin"])();
        const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDatabase"])();
        ...
        const users = await db.collection("user").find(query).sort({
            createdAt: -1
        ...
        const transformedUsers = users.map((user)=>{
            ...
            if (!createdAt && user._id) {
                ...
                } else if (user._id instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"]) {
                    createdAt = user._id.getTimestamp();
                }
            }
            return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3b87d55a._.js.map