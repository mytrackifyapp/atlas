...
"[project]/app/api/founder/fundraise/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const fundraisingData = months.map(({ month, date })=>{
            const committedByMonth = investorInterests.filter((interest)=>{
        ...
        const percentage = fundraise.targetAmount > 0 ? Math.round(fundraise.committedAmount / fundraise.targetAmount * 100) : 0;
        // Calculate days remaining
        const targetCloseDate = fundraise.targetCloseDate instanceof Date ? fundraise.targetCloseDate : new Date(fundraise.targetCloseDate);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Failed to fetch fundraise"
        }, {
            status: 500
        });
    }
...
async function POST(request) {
    try {
        ...
        const { roundType, targetAmount, preMoneyValuation, minInvestment, maxInvestment, startDate, targetCloseDate, useOfFunds, useOfFundsBreakdown, companyDescription, traction, marketOpportunity, competitiveAdvantage, pitchDeck, financialModel } = body;
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Failed to create fundraise"
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__803f3d39._.js.map