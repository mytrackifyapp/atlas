...
"[project]/app/api/founder/investors/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const investors = await db.collection("investor_interests").find({
...
async function POST(request) {
    try {
        ...
        const { name, email, phone, firm, title, amount, stage, status, notes, lastContact } = body;
        ...
        if (status === "Committed" && amount) {
            await db.collection("fundraises").updateOne({
                ...
                $inc: {
                    committedAmount: parseFloat(amount)
                },
                $set: {
                    updatedAt: new Date()
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__326cfd51._.js.map