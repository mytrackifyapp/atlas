...
async function GET(request) {
    try {
        ...
        const onboardingStats = await db.collection("user").aggregate([
            {
                $group: {
        ...
        const signupsOverTime = await db.collection("user").aggregate([
            {
                $match: {
                    createdAt: {
                        $gte: thirtyDaysAgo
...
//# sourceMappingURL=%5Broot-of-the-server%5D__04239f29._.js.map