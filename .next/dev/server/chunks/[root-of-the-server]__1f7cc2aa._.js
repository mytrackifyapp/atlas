...
"[project]/app/api/founder/structure/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const stakeholders = await db.collection("stakeholders").find({
            userId
        }).sort({
            createdAt: -1
        }).toArray();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1f7cc2aa._.js.map