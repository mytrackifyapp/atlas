...
"[project]/app/api/founder/updates/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const updates = await db.collection("investor_updates").find({
            userId
        }).sort({
            sentAt: -1
        }).toArray();
...
async function POST(request) {
    try {
        ...
        const validInvestors = await db.collection("investor_interests").find({
            fundraiseId: fundraise._id.toString(),
            _id: {
                $in: recipients.map((id)=>new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](id))
            },
            status: "Committed"
        }).toArray();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5c18f391._.js.map