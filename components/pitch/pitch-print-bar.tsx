...
export function PitchPrintBar() {
  return (
    <div className="print:hidden sticky top-0 z-10 border-b border-white/10 bg-black/85 backdrop-blur-md">
      <div className="mx-auto max-w-6xl px-4 sm:px-8 py-3 flex items-center justify-between text-base sm:text-lg">
        <span className="font-semibold tracking-tight text-white">Trackify Finance · Pitch</span>
