...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    role: "Founder",
    company: "sintro",
    image: "/testimonials/amina.png",
    content: "Trackify helped us tighten our raise, track investor follow-ups, and keep the data room organized.",
  },
  {
    name: "David O.",
    role: "Partner",
